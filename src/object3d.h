...
class object3d: public hitable
{
    public:
        __device__ object3d() {};
        __device__ object3d(triangle *triangles, int size);
        __device__ object3d(triangle *triangles, int size, material *mat_ptr) : triangles(triangles), num_triangles(size), mat_ptr(mat_ptr) {};
