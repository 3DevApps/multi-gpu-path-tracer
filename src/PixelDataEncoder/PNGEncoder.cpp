...
bool PNGEncoder::encodePixelData(const uint8_t *frame, const int width, const int height, std::vector<uint8_t> &outputData)
{
    ...
    {
        row_pointers[y] = (uint8_t *)&frame[y * width * 3];
    }
