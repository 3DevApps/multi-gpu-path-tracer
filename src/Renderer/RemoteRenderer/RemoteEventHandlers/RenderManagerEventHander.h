...
public:
    ...
    void handleEvent(const Event &event) override
    {
        ...
        case RendererEvent::DOWNLOAD_SCENE_SNAPSHOT:
            ...
            break;
        case RendererEvent::K_PARAMETER:
            manager.setKParameter(rendererEvent.numbervalue());
            break;
    ...
    {
        if (algorithm == RendererEvent::FSFL)
        {
            return SchedulingAlgorithmType::FSFL;
        }
        else if (algorithm == RendererEvent::DSFL)
        {
            return SchedulingAlgorithmType::DSFL;
        }
        else if (algorithm == RendererEvent::DSDL)
        {
            return SchedulingAlgorithmType::DSDL;
        }
        else
        {
            return SchedulingAlgorithmType::FSFL;
